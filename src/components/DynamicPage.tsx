  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white pb-20">
      ...
      <SEO
        ...
        image={pageData.image || (slug?.toLowerCase() === 'cme-ara' ? "https://firebasestorage.googleapis.com/v0/b/new-website-7b8dd.firebasestorage.app/o/AraCEM%20Thumbnail.jpg?alt=media&token=6414fca1-f1d5-4475-916d-fc2404a2ea5f" : "https://firebasestorage.googleapis.com/v0/b/new-website-7b8dd.firebasestorage.app/o/%7BA3113931-E36A-4750-9461-CF9E820F4CE2%7D.jpg?alt=media&token=0ec7467b-89e4-48c1-bde0-97736c744589")}
